      ...
      <div class="container">
        <div class="header-content">
          ...
          <nav class="nav">
            ...
            <router-link to="/image-test" class="nav-link">图片测试</router-link>
    ...
    <section class="hero">
      <div class="container">
        <div class="hero-content">
          <h2 class="hero-title">发现优质商品</h2>
          <p class="hero-subtitle">在这里找到你想要的一切</p>
          <el-input
            v-model="searchQuery"
            placeholder="搜索商品..."
            size="large"
...
import { getProducts, getCategories, type Product, type Category } from '@/services/product'
